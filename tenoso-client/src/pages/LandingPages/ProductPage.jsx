...
function ProductPage() {
  ...
  return (
    <div className="flex w-full flex-col gap-0">
      ...
      <section className="-mt-6 border-y-2 border-zinc-900 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-25">
      ...
      <section className="bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="mx-auto max-w-3xl">
          <div className="mb-8 h-125 w-125 mx-auto flex items-center justify-center overflow-hidden rounded-[1.25rem] border-1 border-zinc-200 shadow-md bg-zinc-100">
            <img
              src={product.image}
              alt={product.title}
          ...
          <div className="mt-8 border-t-2 border-zinc-900 pt-6">
            <Button variant="primary1" className="mr-3">Add to Cart</Button>
            <Button to="/products">Back to Products</Button>
          </div>
        </div>
      </section>

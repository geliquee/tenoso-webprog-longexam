...
const SignInPage = () => {
  return (
    <>
    <main className="w-full max-w-[575px] max-h-full overflow-y-auto rounded-2xl border border-zinc-200 bg-zinc-50/80 px-8 py-6 shadow-2xl sm:px-10">
      <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.2em] text-[#6096ba]">
        Welcome back
      </p>
      ...
      <form className="mt-5 space-y-5">
        ...
        <div className="flex items-center justify-between gap-4 text-sm">
          ...
          <button type="button" className="text-sm font-medium text-[#6096ba] transition hover:text-[#023047]">
            Forgot Password?
          </button>
        </div>

        <Button type="submit" variant="primary1" className={actionButtonClassName}>
          Log In
        </Button>

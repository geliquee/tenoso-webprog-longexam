...
const SignUpPage = () => {
  return (
    <>
      <main className="w-full max-w-[575px] h-screen rounded-none border border-zinc-200 bg-zinc-50/80 px-8 pt-9 py-6 shadow-2xl sm:px-10">
      ...
      <div className="mt-5 border-t border-zinc-200 pt-6 text-sm text-zinc-600">
